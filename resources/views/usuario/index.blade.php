        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav  navbar-right nav-pills">
                    <li><a href="{{ url('home_login') }}" class="page-scroll">Inicio</a></li>
                    ...
                    <li><a href="#tf-testimonials" class="page-scroll">{!! Auth::user()->name !!} {!! Auth::user()->apellido !!}</a></li>
                    <li>
    ...
    <div id="tf-home" class="text-center">
        ...
        <div class="overlay">
            <div class="content">
                ...
                <p class="lead">Registrate por aca <strong>Anos de experiencia </strong> y de <strong>personas extraordinarias</strong></p>
